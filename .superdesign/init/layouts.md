...
## WhiteRoom Studio admin shell

Source: `public/admin/index.html`

Warm light administration shell with topbar, centered content, resource navigation, status tabs, review panel, drawer and dialogs.
...
## WhiteRoom portal shell

Source: `public/portal/index.html`

Dark portal shell with topbar, horizontal deck navigation, main content decks and footer.
